...
public class StringUtil extends StringUtils {
    ...
    public static boolean matches(String str, String pattern) {
        ...
        do {
            ...
            suffixPattern =
                    substring(pattern, formerStarOffset + 1, latterStarOffset > -1 ? latterStarOffset : pattern.length());
     ...
     * String集合拼接成字符串
     *
     * @param listNumbers 字符串结合
     * @return String
     */
    public static String listAppendToString(List<String> listNumbers) {
        StringBuilder sb = new StringBuilder();
